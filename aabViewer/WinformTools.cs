...
namespace aabViewer
{
    public class WinformTools
    {
        ...
        {
            string str = System.Diagnostics.Process.GetCurrentProcess().MainModule.FileName.Replace("HtmlShiWanTool.exe", "");
            return str;
        }
        ...
        public static string GetParentPath(string folder)
        {
